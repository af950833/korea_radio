...
* 2026/04/05 Ver 1.2.2 - 기본 채널 선택 추가(마이그레이션이 안되니 기존 버전에서 생성한 미디어 플레이어는 삭제 후 재생성 필요)
* 2026/04/05 Ver 1.2.3 - SBS 가수/곡명 정보 업데이트 느림 수정
* 2026/08/19 Ver 1.2.4 - 구글 캐스트 지원 PR Merge (캐스트 내용은 처음만 반영되며, 중간에 곡명 변경은 미지원)
* 2026/08/19 Ver 1.2.5 - 향후 Cast 업데이트와의 호환성을 위해 contentType 을 music에서 audio/mpeg 수정
